    ...
    const customers = [
      {
        ...
        avatarUrl: fiskImg,
        rating: 5,
        comment: "Snabb leverans och toppenservice! Nitro ZV21 är den absolut bästa båten jag haft och 10 minuter in i första fisketuren fick jag en 10 kg gädda.",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        avatarUrl: fiskImg,
        rating: 5,
        comment: "Fantastisk kundtjänst! Fick hjälp direkt och produkten var perfekt.",
      },
    ];
          ...
          {customers.map((customer) => (
            <Grid2 key={customer.id} size={{xs: 12, sm:6, md:4}}>
              <Card sx={{ height: "100%",
                ...
                <CardHeader
                  avatar={<Avatar src={customer.avatarUrl} sx={{ width: 56, height: 56 }} />}
                  title={customer.name}
